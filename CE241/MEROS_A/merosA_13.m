...
x2=A2*cos(a(2,i)*n); % Σχηματισμός 2ου Ημιτόνου με το νέο ω2.
 
w=(ones(1,L)); % Δημιουργία του w[n].
...
stem(k,abs(X)); % Εμφάνιση γραφήματος στον Διακριτό Χρόνο.

grid on % Σχεδιασμός γραμμών πλέγματος.
