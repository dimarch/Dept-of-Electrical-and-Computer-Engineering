...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No8');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 11478;
endpos_voiced = 13762;
...
wavwrite(ss1,Fs,16,'e_8_new.wav'); % write the new voiced speech only
