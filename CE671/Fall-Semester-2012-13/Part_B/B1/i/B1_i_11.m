...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No11');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 10810;
endpos_voiced = 13130;
...
wavwrite(ss1,Fs,16,'i_11_new.wav'); % write the new voiced speech only
