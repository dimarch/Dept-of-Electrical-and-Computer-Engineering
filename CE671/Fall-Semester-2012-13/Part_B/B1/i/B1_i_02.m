...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No2');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 15205;
endpos_voiced = 17630;
...
wavwrite(ss1,Fs,16,'i_2_new.wav'); % write the new voiced speech only
