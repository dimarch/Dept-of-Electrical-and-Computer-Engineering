...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No6');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 10575;
endpos_voiced = 14505;
...
wavwrite(ss1,Fs,16,'a_6_new.wav'); % write the new voiced speech only
