...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No11');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 13235;
endpos_voiced = 16895;
...
wavwrite(ss1,Fs,16,'a_11_new.wav'); % write the new voiced speech only
