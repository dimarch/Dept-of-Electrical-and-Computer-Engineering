...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No9');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 9627;
endpos_voiced = 12400;
...
wavwrite(ss1,Fs,16,'i_9_new.wav'); % write the new voiced speech only
