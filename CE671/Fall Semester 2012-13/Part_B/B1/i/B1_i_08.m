...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No8');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 12588;
endpos_voiced = 14476;
...
wavwrite(ss1,Fs,16,'i_8_new.wav'); % write the new voiced speech only
