...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No6');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 16095;
endpos_voiced = 18170;
...
wavwrite(ss1,Fs,16,'i_6_new.wav'); % write the new voiced speech only
