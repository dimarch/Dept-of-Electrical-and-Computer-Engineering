...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No6');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 7930;
endpos_voiced = 10025;
...
wavwrite(ss1,Fs,16,'e_6_new.wav'); % write the new voiced speech only
