...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No8');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 10564;
endpos_voiced = 13846;
...
wavwrite(ss1,Fs,16,'a_8_new.wav'); % write the new voiced speech only
