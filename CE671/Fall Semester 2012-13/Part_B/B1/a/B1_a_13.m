...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No13');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 21916;
endpos_voiced = 25727;
...
wavwrite(ss1,Fs,16,'a_13_new.wav'); % write the new voiced speech only
