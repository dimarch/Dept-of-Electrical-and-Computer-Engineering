...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No5');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 12135;
endpos_voiced = 15521;
...
wavwrite(ss1,Fs,16,'a_5_new.wav'); % write the new voiced speech only
