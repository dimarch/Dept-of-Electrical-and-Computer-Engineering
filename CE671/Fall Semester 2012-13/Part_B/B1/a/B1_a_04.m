...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No4');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 15313;
endpos_voiced = 19135;
...
wavwrite(ss1,Fs,16,'a_4_new.wav'); % write the new voiced speech only
