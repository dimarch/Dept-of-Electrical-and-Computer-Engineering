...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No12');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 15465;
endpos_voiced = 19745;
...
wavwrite(ss1,Fs,16,'a_12_new.wav'); % write the new voiced speech only
