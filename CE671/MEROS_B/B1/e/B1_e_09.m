...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No9');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 16932;
endpos_voiced = 19783;
...
wavwrite(ss1,Fs,16,'e_9_new.wav'); % write the new voiced speech only
