...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No11');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 13330;
endpos_voiced = 16325;
...
wavwrite(ss1,Fs,16,'e_11_new.wav'); % write the new voiced speech only
