...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No1');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 20926;
endpos_voiced = 23165;
...
wavwrite(ss1,Fs,16,'e_1_new.wav'); % write the new voiced speech only
