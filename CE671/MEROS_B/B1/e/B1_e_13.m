...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No13');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 13234;
endpos_voiced = 16180;
...
wavwrite(ss1,Fs,16,'e_13_new.wav'); % write the new voiced speech only
