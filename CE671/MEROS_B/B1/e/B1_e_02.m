...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No2');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 14585;
endpos_voiced = 16898;
...
wavwrite(ss1,Fs,16,'e_2_new.wav'); % write the new voiced speech only
