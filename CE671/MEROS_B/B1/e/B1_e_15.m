...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No15');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 10718;
endpos_voiced = 14480;
...
wavwrite(ss1,Fs,16,'e_15_new.wav'); % write the new voiced speech only
