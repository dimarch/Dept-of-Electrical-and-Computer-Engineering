...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No5');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 8041;
endpos_voiced = 11005;
...
wavwrite(ss1,Fs,16,'e_5_new.wav'); % write the new voiced speech only
