...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No7');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 11903;
endpos_voiced = 14695;
...
wavwrite(ss1,Fs,16,'e_7_new.wav'); % write the new voiced speech only
