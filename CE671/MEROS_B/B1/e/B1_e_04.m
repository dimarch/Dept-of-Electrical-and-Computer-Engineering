...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No4');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 7953;
endpos_voiced = 9573;
...
wavwrite(ss1,Fs,16,'e_4_new.wav'); % write the new voiced speech only
