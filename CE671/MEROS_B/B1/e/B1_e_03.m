...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No3');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 15422;
endpos_voiced = 17638;
...
wavwrite(ss1,Fs,16,'e_3_new.wav'); % write the new voiced speech only
