...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /e/ No14');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 15860;
endpos_voiced = 18431;
...
wavwrite(ss1,Fs,16,'e_14_new.wav'); % write the new voiced speech only
