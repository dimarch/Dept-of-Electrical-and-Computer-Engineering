...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No12');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 8000;
endpos_voiced = 10791;
...
wavwrite(ss1,Fs,16,'i_12_new.wav'); % write the new voiced speech only
