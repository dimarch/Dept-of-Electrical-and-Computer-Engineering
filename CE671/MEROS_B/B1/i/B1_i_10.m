...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No10');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 11282;
endpos_voiced = 14615;
...
wavwrite(ss1,Fs,16,'i_10_new.wav'); % write the new voiced speech only
