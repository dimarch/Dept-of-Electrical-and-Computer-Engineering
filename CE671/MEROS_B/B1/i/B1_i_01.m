...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No1');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 7722;
endpos_voiced = 10365;
...
wavwrite(ss1,Fs,16,'i_1_new.wav'); % write the new voiced speech only
