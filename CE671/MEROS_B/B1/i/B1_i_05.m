...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No5');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 11152;
endpos_voiced = 13710;
...
wavwrite(ss1,Fs,16,'i_5_new.wav'); % write the new voiced speech only
