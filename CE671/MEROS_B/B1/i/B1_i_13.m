...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No13');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 14633;
endpos_voiced = 17821;
...
wavwrite(ss1,Fs,16,'i_13_new.wav'); % write the new voiced speech only
