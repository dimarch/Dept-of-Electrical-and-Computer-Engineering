...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No3');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 10556;
endpos_voiced = 13238;
...
wavwrite(ss1,Fs,16,'i_3_new.wav'); % write the new voiced speech only
