...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No15');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 6005;
endpos_voiced = 9071;
...
wavwrite(ss1,Fs,16,'i_15_new.wav'); % write the new voiced speech only
