...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No4');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 9086;
endpos_voiced = 11533;
...
wavwrite(ss1,Fs,16,'i_4_new.wav'); % write the new voiced speech only
