...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /i/ No7');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 12518;
endpos_voiced = 15120;
...
wavwrite(ss1,Fs,16,'i_7_new.wav'); % write the new voiced speech only
