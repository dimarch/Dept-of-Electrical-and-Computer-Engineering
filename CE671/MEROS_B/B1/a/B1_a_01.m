...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No1');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 10561;
endpos_voiced = 12536;
...
wavwrite(ss1,Fs,16,'a_1_new.wav'); % write the new voiced speech only
