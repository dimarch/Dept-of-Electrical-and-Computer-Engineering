...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No3');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 7970;
endpos_voiced = 10446;
...
wavwrite(ss1,Fs,16,'a_3_new.wav'); % write the new voiced speech only
