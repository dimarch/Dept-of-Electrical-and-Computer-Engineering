...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No10');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 10720;
endpos_voiced = 14445;
...
wavwrite(ss1,Fs,16,'a_10_new.wav'); % write the new voiced speech only
