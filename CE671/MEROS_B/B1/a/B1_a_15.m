...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No15');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 16045;
endpos_voiced = 20398;
...
wavwrite(ss1,Fs,16,'a_15_new.wav'); % write the new voiced speech only
