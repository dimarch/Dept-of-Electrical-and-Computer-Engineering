...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No14');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 11289;
endpos_voiced = 15151;
...
wavwrite(ss1,Fs,16,'a_14_new.wav'); % write the new voiced speech only
