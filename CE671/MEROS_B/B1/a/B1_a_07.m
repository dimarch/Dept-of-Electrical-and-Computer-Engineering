...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No7');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 14540;
endpos_voiced = 17810;
...
wavwrite(ss1,Fs,16,'a_7_new.wav'); % write the new voiced speech only
