...
plot(x);
hold on;
plot(voiced,'r.-'); title('voiced detection for the /a/ No2');
legend('signal','voiced=1, unvoiced/silence=0');
grid on;
%%

% The voiced speech
startpos_voiced = 11222;
endpos_voiced = 13849;
...
wavwrite(ss1,Fs,16,'a_2_new.wav'); % write the new voiced speech only
